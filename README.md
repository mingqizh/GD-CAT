...
> [!IMPORTANT]
> For the human gene symbol, you should input an **ALL CAPITALIZED** gene symbol, like `ADIPOQ`; while for the mouse data, you only need capital the **FIRST** letter, like `Adipoq`.<br><br>
